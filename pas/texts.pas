...
Const HntBufempty = 'Buffer empty';
    ...
    HntDemoNewPage = 'Demoversion is limited to four pages';
    HntUnmarkPageFirst = 'Unmark page first by [F9]';
    HntPageEmpty = 'Page empty';
    HntDemoNIL = 'Demo version: cannot open this file';
    HntDemoBuf = 'Cannot use buffer files in demoversion';
    HntDemoCRCTestfile = 'Demoversion: TESTFILE.RNS has been changed, restoring previous one';
    HntDemoCRC = 'Demoversion: file has been changed, restore from original diskette';
